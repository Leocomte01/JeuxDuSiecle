...
public abstract class ArmyManager : MonoBehaviour
{
    ...
    public virtual GameObject GetRandomWeakEnemies<T>() where T : ArmyElement
        {
            return null;
        }
    ...
    public virtual GameObject getWeakDroneByDistanceByType<T>(Vector3 centerPos, float minRadius, float maxRadius) where T : ArmyElement
    {
        return null;
    }
